    ...
    <>
      <Accordion title="Nodes - Animations">
        <p>
          ...
          <span style={{ fontWeight: 'bold', color: '#6E58FF' }}>Node Image</span><br /> The image inserted into the node signifies that the animation has either won an award (crown) or is ranked within the Top 5.<br /><br />
  ...
  const systemInfo = (
    <p>
      ...
      <Accordion title="Interactions">
        <p>
          <span style={{ fontWeight: 'bold', color: '#6E58FF' }}>Network Type Selection</span><br />Choose Animation / Creator Network.<br /><br />
          <span style={{ fontWeight: 'bold', color: '#6E58FF' }}>Edge Type Selection</span><br />Select various types of connections for each network type.<br /><br />
          <span style={{ fontWeight: 'bold', color: '#6E58FF' }}>Node Filtering</span><br />Choose the type of nodes you want to see for each network type.<br /><br />
          <span style={{ fontWeight: 'bold', color: '#6E58FF' }}>Control Panel</span><br />Music Play, Fullscreen, Zoom In, Zoom Out, Reset functions.<br /><br />
